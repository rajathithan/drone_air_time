...
- **Required Parameters:**
    ...
    - `timezone`: **MANDATORY.** The specific timezone string provided by the Analyzer/OpenMeteo (e.g., "America/New_York" or "Asia/Kolkata").
...
3. **Verification:** Ensure the `selected_window` and `timezone` are present.
...
2. **Mapping:**
    ...
    - **Timezone Field:** Pass the `timezone` string.
